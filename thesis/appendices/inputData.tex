...
\begin{table}[H]
    ...
    This file includes 16 lines, with a number indicating the amount of nodes, and the (x,y) coordinates for the 15 nodes. These coordinates was not supplied in Mandl's literature, so they are copied from \citet{mumford13} and are approximate for the picture to be drawn.
\end{table}
