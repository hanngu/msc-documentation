...
Neo4j[] includes two built-in algorithms for finding the shortest path, including A* search\citep{russel10}  and Dijkstra's\citep{cormen09}. 
...
As seen in table \ref{table:astarvsdijkstras},
