...
The baseline of the proposed algorithm, SuperSwarm Optimization (SSO), is the ACO metaheuristic shown in Algorithm \vref{algo:aco}. As initiated in Section \vref{sec:problemStatement}, will the some acknowledged attributes, inspired by PSO and BCO, be added to the ACO algorithm.
