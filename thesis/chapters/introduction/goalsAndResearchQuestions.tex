...
\item
    ...
    \item \label{itm:2b} How does the parameter settings affect the solution quality of the algorithm?
    \item \label{itm:2c} Is it possible to apply the proposed algorithm to optimize bus routes in urban cities?
    \end{enumerate}
