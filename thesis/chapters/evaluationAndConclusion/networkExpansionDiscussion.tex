...
Comparing the results produced by the proposed system on the Mumford0 and Mumford1 networks to the results on the Mandl Network, one can see that the performance worsen.
