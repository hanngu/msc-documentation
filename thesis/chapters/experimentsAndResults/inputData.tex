...
\begin{figure}[H]
  ...
  \caption[Transit Network]
   ...
   The transit network including the 15 nodes and 21 edges. The graph is undirected, because most lines use same arcs in both directions. Coordinates are correct based on the MandlCoordinates.txt file from \citep{mumford13}
\end{figure}