...
%C++ is faster because in Java programs all the classes have to be compiled first, but this difference becomes insignificant in case of larger applications.
