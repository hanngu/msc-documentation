...
When a parameter value is selected, this parameter will be changed and held constant for the next parameter setting experiments. The tests are performed in the following order; $p_{e}$, 
