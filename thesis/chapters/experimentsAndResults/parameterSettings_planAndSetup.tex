...
In addition will studying the effect of the additional parameters inspired by PSO and BCO help establish whether these attributes improves the basic ACO algorithm in order to answer Research Question \vref{itm:RQ2}.
