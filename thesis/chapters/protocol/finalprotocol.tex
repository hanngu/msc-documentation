...
\subsection{Scoring}
Point 1-13 given a score, with the granularity 0 (no), $\frac{1}{2}$ (partly), and 1 (yes). For this structured literature review we wanted to emphasize on the quality criteria that covered the relevance. We read some literature that were quite good regarding to for example structure and composition, but who were not relevant for our thesis. Therefor, we chose to multiply the 1a and 1b quality criteria with 3.  
