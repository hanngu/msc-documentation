...
As mentioned does %private transportation has a lot of advances for the citizens compared to the public transportation system. The public transportation system contains less nodes (stops), resulting in longer travel distances between two nodes, in addition to a longer walking distance. 
...
%Throughout our research we will evaluate our work against the following criteria: 
%\begin{itemize}
