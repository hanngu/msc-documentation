...
A graph database management system \citep{robinson13} (henceforth, a graph database) is an online database management system %with Create, Read, Update, and Delete (CRUD) methods, and is 
